...
namespace FamilyTree.Objects
{
    ...
    public class clsRelationship
    {
        ...
        public clsRelationship(Person oOwner, int nPartnerID)
        {
            m_nID = 0;
            m_bDelete = false;
            m_oOwner = oOwner;
            partnerIndex_ = nPartnerID;
            if (m_oOwner.isMale)
            {
		...
		/// <param name="oOwner">Specifies the owner of this relationship object.</param>
		/// <param name="nPartnerID">Specifies the partner in this relationship..</param>
        public clsRelationship(int nID, Person oOwner, int nPartnerID)
        ...
        {
            Person oPartner = m_oOwner.Database.getPerson(partnerIndex_);
